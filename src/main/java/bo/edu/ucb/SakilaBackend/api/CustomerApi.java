...
public class CustomerApi {
    ...
    public String UpdateCustomerAddress(@RequestBody Integer customerId, @RequestBody Address address){
        return customerBl.UpdateCustomerAddress(customerId, address);
    }
